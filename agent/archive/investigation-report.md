...
The next document (**agent/archive/augmentation-plan.md**) specifies concrete steps to augment the committee and review skills so they produce and consume this structure using only cyber-sense’s roster and artifacts.
